...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'id_tps'           => ['type' => 'int', 'constraint' => 3, 'null' => true],
        ...
        $fields = [
            ...
            'nama_tps' => ['type'  => 'VARCHAR', 'constraint'  => 50],
            'created_at' => ['type' => 'DATETIME', 'null' => true],
            'updated_at' => ['type' => 'DATETIME', 'null' => true],
            'deleted_at' => ['type' => 'DATETIME', 'null' => true]
        ];
        ...
        $fields = [
            ...
            'id_paslon' => ['type' => 'INT', 'constraint' => 3, 'unsigned' => true],
            'id_tps' => ['type' => 'INT', 'constraint' => 3, 'unsigned' => true],
            'created_at' => ['type' => 'DATETIME', 'null' => true],
            'updated_at' => ['type' => 'DATETIME', 'null' => true],
            'deleted_at' => ['type' => 'DATETIME', 'null' => true],
        ];
